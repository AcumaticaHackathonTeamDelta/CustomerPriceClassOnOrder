...
public partial class _Main : PX.Web.UI.PXPage, ITitleModuleController
{
	...
	void UserNameMenu_ItemClick(object sender, PXMenuItemEventArgs e)
	{
		if (e.Item.Value == "LogOut")
		{
			...
			string redirectUrl = (String.IsNullOrEmpty(absoluteLoginUrl)) ? ResolveUrl("~/Main.aspx") : absoluteLoginUrl;
			if (!String.IsNullOrEmpty(redirectUrl)) redirectUrl = PXUrl.AppendUrlParameter(redirectUrl, PX.Data.Auth.ExternalAuthHelper.SILENT_LOGIN, "None");
