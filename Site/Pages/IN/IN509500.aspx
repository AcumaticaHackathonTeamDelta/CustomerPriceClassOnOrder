<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="IN509500.aspx.cs"
    Inherits="Page_IN509500" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.Objects.IN.INRepForecastApplicationGraph"
                     BorderStyle="NotSet" PageLoadBehavior="PopulateSavedValues"/>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Selection" DataMember="Filter" TabIndex="900" >
        <Template>
			...
			<px:PXSelector ID="edItemClassID" runat="server" CommitChanges="True" DataField="ItemClassID" />			
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" AllowPaging="true" Width="100%" SkinID="PrimaryInquire" Caption="Items Requiring Replenishment">
        ...
        <Levels>		
            <px:PXGridLevel  DataMember="Records">                
                <Columns>                   
					...
					<px:PXGridColumn DataField="LastFCApplicationDate" 
						DataType="DateTime" TextAlign="Center" Width="90px">
					</px:PXGridColumn>
