...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="513px" DataSourceID="ds" DataMember="itemsitesettings">
        ...
        <Items>
            <px:PXTabItem Text="General Settings" RepaintOnDemand="false">
                <Template>
                    ...
                    <px:PXSelector CommitChanges="True" ID="edBaseUnit" runat="server" DataField="InventoryItem__BaseUnit" AllowEdit="True" />
                    <px:PXCheckBox ID="chkDfltUnitOverride" runat="server" DataField="DfltUnitOverride" CommitChanges="true" />
                    <px:PXSelector CommitChanges="True" ID="edDfltSalesUnit" runat="server" DataField="DfltSalesUnit" AutoRefresh="True" AllowEdit="True">
                        <Parameters>
                            <px:PXControlParam ControlID="tab" Name="InventoryItem.baseUnit" PropertyName="DataControls[&quot;edBaseUnit&quot;].Value"
                                Type="String" />
                        </Parameters>
                    </px:PXSelector>
                    <px:PXSelector CommitChanges="True" ID="edDfltPurchaseUnit" runat="server" DataField="DfltPurchaseUnit" AutoRefresh="True"
                        AllowEdit="True">
                        <Parameters>
                            <px:PXControlParam ControlID="tab" Name="InventoryItem.baseUnit" PropertyName="DataControls[&quot;edBaseUnit&quot;].Value"
                                Type="String" />
                    ...
                    <px:PXGrid ID="gridUnits" runat="server" DataSourceID="ds" Width="400px" Height="121px" SkinID="ShortList">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="itemunits">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="UnitMultDiv" Width="72px" RenderEditorText="True" />
