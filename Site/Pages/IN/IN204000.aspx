                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="location" DataKeyNames="SiteID,LocationCD">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edPrimaryItemClassID" runat="server" DataField="PrimaryItemClassID" Width="63px" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="AssemblyValid" DataType="Boolean" DefValueText="True" TextAlign="Center" Type="CheckBox"
                                        Width="60px"/>
                                    <px:PXGridColumn AllowNull="False" DataField="PickPriority" DataType="Int16" TextAlign="Right" Width="80px"/>
                                    ...
                                    <px:PXGridColumn DataField="PrimaryItemClassID" DisplayFormat="&gt;aaaaaa" Width="63px"/>
