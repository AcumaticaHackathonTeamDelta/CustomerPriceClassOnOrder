						...
						<Levels>
							<px:PXGridLevel DataMember="ClassItems" >
								<RowTemplate>
									...
									<px:PXTextEdit ID="edRQInventoryItem__ItemClassID" runat="server" DataField="RQInventoryItem__ItemClassID" AllowEdit="True" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="RQInventoryItem__ItemClassID" DisplayFormat="&gt;aaaaaaaaaa"  />
