...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXSmartPanel runat="server" ID="panelVendor" CaptionVisible="true" Caption="Vendor Address" Key="Vendors" AutoCallBack-Command="Refresh" AutoCallBack-Enabled="True"
        ...
        <px:PXPanel ID="panelVC" runat="server" Style="margin-top: 5px; z-index: 100; margin-left: 5px; margin-right: 5px; margin-bottom: 20px; position: relative; top: 0px;
            ...
            <px:PXFormView ID="formVC" runat="server" CaptionVisible="False" DataMember="Bidding_Remit_Contact" DataSourceID="ds" Width="100%" AllowCollapse="false">
                <CallbackCommands>
            ...
            <px:PXFormView ID="formVA" DataMember="Bidding_Remit_Address" runat="server" DataSourceID="ds" Width="100%" CaptionVisible="False" Style="left: 0px; position: absolute;
                top: 144px" SyncPosition="true" >
                <CallbackCommands>
                    <Save RepaintControls="None" />
                </CallbackCommands>
        ...
        <Items>
            ...
            <px:PXTabItem Text="Shipping Instructions">
                <Template>
                    ...
                    <px:PXFormView ID="formSC" runat="server" CaptionVisible="False" DataMember="Shipping_Contact" DataSourceID="ds" Width="100%" RenderStyle="Simple">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
                    ...
                    <px:PXFormView ID="formSA" runat="server" CaptionVisible="False" DataMember="Shipping_Address" DataSourceID="ds" Width="100%" SyncPosition="true" RenderStyle="Simple">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
                            <px:PXCheckBox CommitChanges="True" SuppressLabel="True" ID="chkOverrideAddress" runat="server" DataField="OverrideAddress" Height="18px" />
            ...
            <px:PXTabItem Text="Vendor Info">
                <Template>
                    ...
                    <px:PXPanel RenderStyle="Fieldset" ID="panelVC" runat="server" Caption="Vendor Address">
                        <px:PXFormView ID="formVC" runat="server" CaptionVisible="False" DataMember="Remit_Contact" DataSourceID="ds" Width="100%" AllowCollapse="False">
                            <Template>
                                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
                                <px:PXCheckBox CommitChanges="True" ID="chkOverrideContact" runat="server" DataField="OverrideContact" />
                                <px:PXTextEdit ID="edFullName" runat="server" DataField="FullName" />
                        ...
                        <px:PXFormView ID="formVA" DataMember="Remit_Address" runat="server" DataSourceID="ds" Width="100%" CaptionVisible="False" Style="left: 0px; position: absolute;
                            top: 144px; height: 240px" AllowCollapse="False" Height="240px" SyncPosition="true" >
                            <Template>
                                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
                                <px:PXCheckBox CommitChanges="True" ID="chkOverrideAddress" runat="server" DataField="OverrideAddress" />
								<px:PXCheckBox ID="chkIsValidated" runat="server" DataField="IsValidated" Enabled="False"/>
