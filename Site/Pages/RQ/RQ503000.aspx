					...
					<px:PXGrid ID="gridVendor" runat="server" DataSourceID="ds" Width="100%" SkinID="Details"
						...
						<Levels>
							<px:PXGridLevel DataMember="Vendors" >
								...
								<Columns>
									<px:PXGridColumn DataField="VendorID" DisplayFormat="&gt;AAAAAAAAAA" Width="100px" AutoCallBack="true" />
									<px:PXGridColumn DataField="VendorID_Vendor_AcctName" Width="300px" />
									<px:PXGridColumn DataField="VendorLocationID" DisplayFormat="&gt;AAAAAA" Width="100px" AutoCallback="true" />
									...
									<px:PXGridColumn DataField="EntryDate" Width="90px" />
									<px:PXGridColumn DataField="ExpireDate" Width="90px" />
									<px:PXGridColumn DataField="PromisedDate" Width="90px" />
									<px:PXGridColumn AllowNull="False" DataField="TotalQuoteQty" TextAlign="Right" Width="100px" />
									<px:PXGridColumn DataField="CuryInfoID" Width="54px" TextField="CuryID" />
									<px:PXGridColumn AllowNull="False" DataField="CuryTotalQuoteExtCost" TextAlign="Right" Width="100px" />
			...
			<px:PXTabItem Text="Bidding Results" Overflow="Hidden" LoadOnDemand="true">
                <Template>
                    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300" SkinID="Horizontal" Height="200px" Panel1MinSize="175" Panel2MinSize="175">
                        <AutoSize Enabled="true" />
                        <Template1>
                            <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" Caption="Requisition Details">
                                <Levels>
                                    <px:PXGridLevel DataMember="Lines">
                                        <Columns>
                                            ...
                                            <px:PXGridColumn AllowNull="False" DataField="BiddingQty" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn AllowNull="False" DataField="CuryEstUnitCost" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn AllowNull="False" DataField="CuryEstExtCost" TextAlign="Right" Width="100px" />
                                        </Columns>
                                    </px:PXGridLevel>
                                </Levels>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="Bidding">
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="VendorLocationID" DisplayFormat="&gt;AAAAAA" Width="100px" AutoCallBack="true" />
                                            <px:PXGridColumn DataField="QuoteNumber" Width="140px" />
                                            <px:PXGridColumn AllowNull="False" DataField="MinQty" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn AllowNull="False" DataField="QuoteQty" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn DataField="CuryID" Width="80px" />
                                            <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="CuryQuoteUnitCost" TextAlign="Right" Width="81px" />
                                            <px:PXGridColumn AllowNull="False" DataField="CuryQuoteExtCost" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn AllowNull="False" DataField="OrderQty" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn DataField="Location__VShipTermsID" Width="80px" />
                                            ...
                                            <px:PXGridColumn DataField="RQBiddingVendor__ExpireDate" Width="90px" />
                                            <px:PXGridColumn DataField="RQBiddingVendor__PromisedDate" Width="90px" />
                                        </Columns>
                                    </px:PXGridLevel>
                                </Levels>
