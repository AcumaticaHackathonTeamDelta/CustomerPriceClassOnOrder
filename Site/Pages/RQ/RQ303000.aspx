			...
			<px:PXTabItem Text="Vendor Info">
				<Template>
                    ...
                    <px:PXPanel RenderStyle="Fieldset" ID="panelVC" runat="server" Caption="Vendor Address" >
						<px:PXFormView ID="formVC" runat="server" CaptionVisible="False" AllowCollapse="false"
							...
							<Template>
								...
								<px:PXMailEdit ID="edEmail" runat="server" DataField="Email" /></Template>
							<ContentStyle BackColor="Transparent" BorderStyle="None">
							</ContentStyle>
						</px:PXFormView>
						<px:PXFormView ID="formVA" DataMember="Remit_Address"  runat="server" AllowCollapse="false"
							DataSourceID="ds" Width="100%" CaptionVisible="False" Style="left: 0px;
							position: absolute; top: 144px; height: 220px">
							<Template>
								<px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="SM" ControlSize="M" />
