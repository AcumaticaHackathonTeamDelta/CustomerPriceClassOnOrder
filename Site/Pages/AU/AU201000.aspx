            ...
            <px:PXFormView ID="formPageWizard" runat="server" Width="100%" DataSourceID="ds" SkinID="Transparent" DataMember="ViewPageWizard">
                <Template>
                    ...
                    <px:PXDropDown ID="Template" runat="server" DataField="Template" />
                   	...
                   	<px:PXTreeSelector ID="SiteMap" runat="server" DataField="SiteMap" PopulateOnDemand="True" 
				        ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="SiteMapTree" MinDropWidth="413" CommitChanges="False">
				        <DataBindings>
