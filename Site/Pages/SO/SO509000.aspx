        ...
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="SubItemID" DisplayFormat="&gt;AA-A" Width="70px" />
					<px:PXGridColumn AllowUpdate="False" DataField="SourceSiteID" DisplayFormat="&gt;AAAAAAAAAA" Label="Replenishment Warehouse"
                        Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="DemandSiteID" DisplayFormat="&gt;AAAAAAAAAA" Width="100px" />
					...
					<px:PXGridColumn AllowUpdate="False" DataField="SOOrder__CustomerID" Width="90px" />
					<px:PXGridColumn AllowUpdate="False" DataField="SOOrder__CustomerID_BAccountR_acctName" Width="90px" />
					<px:PXGridColumn AllowUpdate="False" DataField="SOOrder__OrderNbr" Width="90px"  />
					<px:PXGridColumn AllowUpdate="False" DataField="ExtWeight" Width="90px" /> 
					<px:PXGridColumn AllowUpdate="False" DataField="ExtVolume" Width="90px" /> 
                </Columns>
            </px:PXGridLevel>
        </Levels>
