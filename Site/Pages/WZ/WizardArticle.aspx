<%@ Page Language="C#" MasterPageFile="~/MasterPages/TabView.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="WizardArticle.aspx.cs"
    Inherits="WizardArticle" Title="Untitled Page"  %>
...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.Objects.WZ.WizardArticleMaint" PrimaryView="Tasks" Visible="True">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="MarkAsComplete"/>
            <px:PXDSCallbackCommand Name="GoToScreen"/> 
            <px:PXDSCallbackCommand Name="Assign" CommitChanges="True"/> 
            <px:PXDSCallbackCommand Name="ViewOptionalTask" Visible="false" DependOnGrid="optionalTasksGrid" CommitChanges="True"/> 
                ...
                <Items>
                    <px:PXTabItem Text="Summary">
                        <Template>
                           ...
                           <%--<px:PXRichTextEdit ID="edDetails" runat="server" Style="border-width: 0px; width: 100%;"
                                              DataField="Details" TextMode="MultiLine">
                               <AutoSize Enabled="True" />
                           </px:PXRichTextEdit>--%>
                        </Template>
                    </px:PXTabItem>
                    <px:PXTabItem Text="Optional Tasks">
                        <Template>
                        <px:PXGrid runat="server" ID="optionalTasksGrid" DataSourceID="ds" Caption="Optional Tasks" Style="width: 100%;" SkinID="Inquire">
                                <Levels>
                                    <px:PXGridLevel DataMember="OptionalTasks">
                                        <Columns>
                                            <px:PXGridColumn DataField="Status" Width="80px"/>
                                            <px:PXGridColumn DataField="Name" Width="350px" LinkCommand="ViewOptionalTask"/>
                    ...
                    <px:PXTabItem Text="Depends on Tasks">
                        <Template>
