    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            ...
            <px:PXDateTimeEdit CommitChanges="True" runat="server" DataField="DocDate" ID="edDocDate" />
             <px:PXCheckBox ID="chkIncludeNonOverdue" runat="server" DataField="IncludeNonOverdueDunning"/>
        ...
        <Levels>
            <px:PXGridLevel DataMember="DunningLetterList">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="CustomerClassID" Width="100px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="BAccountID" Width="100px" />
                    ...
                    <px:PXGridColumn DataField="LastDunningLetterDate" Width="90px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
