...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		AllowPaging="True" AllowSearch="True" AdjustPageSize="Auto" DataSourceID="ds" SkinID="Inquire" TabIndex="800" Caption="Documents to claim">
		<Levels>
			<px:PXGridLevel DataKeyNames="DocType,RefNbr" DataMember="Documents">
			    <RowTemplate>
                    <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" CommitChanges="True" AllowEdit="True">
                    </px:PXSelector>
                </RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn DataField="RUTROT__RUTROTType" Width="100px">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="RUTROT__CuryDistributedAmt" TextAlign="Right" Width="150px">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="RUTROT__ClaimDate" Width="90px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="RUTROT__ExportRefNbr" Width="90px">
                    </px:PXGridColumn>
                </Columns>
			</px:PXGridLevel>
		</Levels>
