						...
						<Levels>
							<px:PXGridLevel DataMember="SPCustomers">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="LocationID_Location_descr" Width="200px" />
									<px:PXGridColumn DataField="CommisionPct" TextAlign="Right" Width="100px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<ActionBar>
					...
					<px:PXGrid ID="grid" runat="server" Height="300px" Width="100%" SkinID="DetailsInTab" TabIndex="200">
						<Levels>
							<px:PXGridLevel DataMember="CommissionsHistory">
								...
								<Columns>
									<px:PXGridColumn DataField="CommnPeriod" Width="100px" />
                                    ...
                                    <px:PXGridColumn  DataField="PRProcessedDate"  Width="140px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
