...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Invoice Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity"
        LinkIndicator="True" NotifyIndicator="True" DefaultControlID="edDocType" TabIndex="100" MarkRequired="Dynamic">
        <CallbackCommands>
            <Save PostData="Self" />
        </CallbackCommands>
        ...
        <Template>
            ...
            <px:PXDropDown Size="xs" ID="edStatus" runat="server" DataField="Status" Enabled="False" />
            ...
            <pxa:PXCurrencyRate DataField="CuryID" ID="edCury" runat="server" RateTypeView="_ARCashSale_CurrencyInfo_" DataMember="_Currency_"></pxa:PXCurrencyRate>
        ...
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryExtPrice" TextAlign="Right" Width="81px" />
            ...
            <px:PXTabItem Text="Billing Address">
                <Template>
                    ...
                    <px:PXCheckBox ID="chkEmailed" runat="server" DataField="Emailed" Size="SM" AlignLeft="true" />
