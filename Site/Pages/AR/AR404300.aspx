		...
		<Levels>
			<px:PXGridLevel DataMember="Details">
				<Columns>
					...
					<px:PXGridColumn DataField="StatementBalance"  TextAlign="Right" Width="120px" />
					<px:PXGridColumn DataField="OverdueBalance"  TextAlign="Right" Width="120px" />
					<px:PXGridColumn DataField="CuryID" />
					<px:PXGridColumn DataField="CuryStatementBalance"  TextAlign="Right" Width="120px" />
					<px:PXGridColumn DataField="CuryOverdueBalance"  TextAlign="Right" Width="120px" />
