		...
		<Items>
			<px:PXTabItem Text="General Settings" RepaintOnDemand="false">
				<Template>
                    ...
                    <px:PXLayoutRule runat="server" Merge="False" />
                    <px:PXLayoutRule runat="server" ControlSize="M"  LabelsWidth="M" Merge="True" SuppressLabel="true" />
					<px:PXCheckBox ID="chkSendStatementByEmails" runat="server" DataField="SendStatementByEmail"  Size="M"/>
					<px:PXCheckBox ID="chkPrintStatements" runat="server" DataField="PrintStatements"  Size="M"/>
                    <px:PXLayoutRule runat="server" Merge="False" />
