...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
		...
		<Items>
			<px:PXTabItem Text="Details" RepaintOnDemand="False">
				<Template>
					...
					<px:PXTextEdit ID="FirstName" runat="server" DataField="FirstName" Width="164px"  LabelID="LFirstName" />
					...
					<px:PXMaskEdit ID="Phone3" runat="server" DataField="Phone3" Width="134px" LabelID="LPhone3"/>
					...
					<px:PXLayoutRule runat="server" />
					<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
                    <px:PXLayoutRule ID="PXLayoutRule5" runat="server" GroupCaption="CRM" StartGroup="True" ControlSize="XM" LabelsWidth="M"/>
					...
					<px:PXDropDown ID="Source" runat="server" DataField="Source" CommitChanges="True"/>
					...
					<px:PXCheckBox ID="edNoMarketingMaterials" runat="server" DataField="NoMarketing"
						Size="S" />
					<px:PXLayoutRule ID="PXLayoutRule13" runat="server" ControlSize="XM" LabelsWidth="M"/>
                    <px:PXDateTimeEdit ID="edLastIncomingDate" runat="server" DataField="CRActivityStatistics__LastIncomingActivityDate" Enabled="False" Size="SM"/>
                    <px:PXDateTimeEdit ID="edLastOutgoingDate" runat="server" DataField="CRActivityStatistics__LastOutgoingActivityDate" Enabled="False" Size="SM"/>
					...
					AllowPaging="True" ActionsPosition="Top" AllowSearch="true" DataSourceID="ds" SkinID="Details">
						<Levels>
							<px:PXGridLevel DataMember="Subscriptions">
								<Columns>
									<px:PXGridColumn DataField="MarketingListID" Width="120px" AutoCallBack="true" DisplayMode="Text" TextField="CRMarketingList__MailListCode"
    ...
    <px:PXSmartPanel ID="spMergeParamsDlg" runat="server"
        ...
        <px:PXGrid ID="grdFields" runat="server" Height="350px" Width="100%" DataSourceID="ds" MatrixMode="True">
                    <Levels>
