        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <RowTemplate>
                    ...
                    <px:PXNumberEdit ID="edScheduleID" runat="server" DataField="ScheduleID" Enabled="False" ValidateRequestMode="Inherit" />
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="ScheduleID" Width="72px" TextAlign="Right" LinkCommand="ViewSchedule" />
