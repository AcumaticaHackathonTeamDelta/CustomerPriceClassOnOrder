		...
		<Items>
			<px:PXTabItem Text="Summary">
				<Template>
					...
					<px:PXSelector runat="server" ID="PXSelector1" DataField="CaseItemID" AutoRefresh="true" Size="M" Enabled="False" AllowEdit="True" />
				</Template>
			</px:PXTabItem>
			...
			<px:PXTabItem Text="Employees Override">
				<Template>
