...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="669px" Width="100%" DataMember="CASetupRecord"
		...
		<Items>
			...
			<px:PXGrid ID="gridApproval" runat="server" Width="450px" Height="200px" TabIndex="11900" DataSourceID="ds">
				<Levels>
		...
		<px:PXTabItem Text="Bank Statement Settings">
			<Template>
				<px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XM" StartGroup="True" GroupCaption="Disbursement Date Matching"/>				
				...
				<px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XM" StartGroup="True" GroupCaption="Receipt Date Matching"/>
