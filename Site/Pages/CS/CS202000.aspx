...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Header" Caption="Segmented Key Definition" TemplateContainer="" DataSourceID="ds" >
		<Template>
			...
			<px:PXSelector ID="edDimensionID" runat="server" DataField="DimensionID"  DataSourceID="ds" />
			<px:PXSelector ID="edParentDimensionID" runat="server" DataField="ParentDimensionID" Enabled="False" DataSourceID="ds" />
			<px:PXCheckBox ID="chkValidate" runat="server" DataField="Validate" />
			<px:PXSelector ID="edSpecificModule" runat="server" DataField="SpecificModule" DataSourceID="ds" />
			<px:PXSelector ID="edNumberingID" runat="server" DataField="NumberingID" AllowEdit="True" DataSourceID="ds" />
