		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXLayoutRule ID="PXLayoutRule1" runat="server" GroupCaption="Price Retention Settings" StartGroup="True" />
			...
			<px:PXTabItem Text="Approval">
				<Template>
					<px:PXLayoutRule runat="server" GroupCaption="Document Approval Settings" ControlSize="XM" LabelsWidth="S" StartGroup="True" />
					<px:PXCheckBox ID="chkInvoiceRequestApproval" runat="server" AlignLeft="True" Checked="True" DataField="InvoiceRequestApproval" CommitChanges="True" />
					<px:PXGrid ID="gridApproval" runat="server" DataSourceID="ds" SkinID="Details" Width="516px">
						<AutoSize Enabled="True" />
						<Levels>
							<px:PXGridLevel DataMember="SetupApproval">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXSelector ID="edAssignmentMapID" runat="server" TextField="Name" DataField="AssignmentMapID" AllowEdit="True" CommitChanges="True" />
			...
			<px:PXTabItem Text="Mailing Settings">
				<Template>
					<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300" SkinID="Horizontal" Height="500px">
						<AutoSize Enabled="true" />
						<Template1>
							<px:PXGrid ID="gridNS" runat="server" SkinID="DetailsInTab" Width="100%" DataSourceID="ds" Height="150px" Caption="Default Sources" AdjustPageSize="Auto" AllowPaging="True" TabIndex="300">
