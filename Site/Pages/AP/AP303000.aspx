...
s			<px:PXButton ID="btnOK" runat="server" DialogResult="OK" Text="OK">
		...
		<Items>
			<px:PXTabItem Text="General Info" RepaintOnDemand="false">
				<Template>
					...
					<px:PXCheckBox ID="chkLandedCostVendor" runat="server"  AllowEdit="True" DataField="LandedCostVendor" />
					<px:PXCheckBox CommitChanges="True" ID="chkTaxAgency" runat="server" DataField="TaxAgency" />
                    <px:PXCheckBox ID="chkLaborUnion" runat="server"  AllowEdit="True" DataField="IsLaborUnion" />
			...
			<px:PXTabItem Text="Tax Agency Settings" BindingContext="tab" VisibleExp="DataControls[&quot;chkTaxAgency&quot;].Value = 1">
				<Template>
					...
					<px:PXCheckBox ID="chkEnableTaxStartDate" runat="server" DataField="EnableTaxStartDate" CommitChanges="true" />
					<px:PXDropDown ID="edTaxYearStartDate" runat="server" DataField="TaxYearStartDate" />
