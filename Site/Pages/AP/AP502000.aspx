...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="150px" Style="z-index: 100" Width="100%" Caption="Pending Documents" AllowPaging="true" AdjustPageSize="Auto" SyncPosition="true" SkinID="PrimaryInquire" FastFilterFields="RefNbr,DocDesc,VendorID,VendorID_Vendor_acctName">
        <Levels>
