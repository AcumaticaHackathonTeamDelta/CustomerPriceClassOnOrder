...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="server">
	<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="200" Panel1MinSize="150" Panel2MinSize="700">
						...
						<Template>
							<px:PXFormView ID="formRules" runat="server" DataSourceID="ds" DataMember="StepRules" Width="100%" SkinID="Transparent">
								<Template>
									...
									<pxa:PMFormulaEditor ID="edQtyFormula" runat="server" DataSourceID="ds" DataField="QtyFormula" Parameters="@Rate" />
									<pxa:PMFormulaEditor ID="edBillableQtyFormula" runat="server" DataSourceID="ds" DataField="BillableQtyFormula" Parameters="@Rate" />
									<pxa:PMFormulaEditor ID="edAmountFormula" runat="server" DataSourceID="ds" DataField="AmountFormula" Parameters="@Rate" />
									<pxa:PMFormulaEditor ID="edDescriptionFormula" runat="server" DataSourceID="ds" DataField="DescriptionFormula" Parameters="@Rate" />
