...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Task" LinkPage=""
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
			<px:PXSelector ID="PXSelector1" runat="server" DataField="AllocationID" DataSourceID="ds"  AllowAddNew="True" AllowEdit="True"/>
            <px:PXSelector ID="edBillingID" runat="server" DataField="BillingID" DataSourceID="ds"  AllowAddNew="True" AllowEdit="True"/>
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="341px" DataSourceID="ds" DataMember="TaskProperties" LinkPage="">
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
                    <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" GroupCaption="General Settings" />
                    ...
                    <px:PXLayoutRule ID="PXLayoutRule2" runat="server" StartColumn="True" StartGroup="True" GroupCaption="Visibility Settings" />
