	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" 
				ControlSize="M" />
			<px:PXSelector ID="edCompanyID" runat="server" DataField="CompanyID" ReadOnly="True"
	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CompanyCurrent"
		...
		<Items>
			<px:PXTabItem Text="Snapshots">
				<Template>
					<px:PXGrid ID="gridSnapshots" runat="server" DataSourceID="ds" Style="position: static"
			...
			<px:PXTabItem Text="Snapshot Restoration History">
				<Template>
					<px:PXGrid ID="gridHistory" runat="server" DataSourceID="ds" Style="position: static"
						Width="100%" ActionsPosition="Top" AdjustPageSize="Auto" AllowPaging="True" SkinID="DetailsInTab">
						<AutoSize Enabled="true" />
						<Levels>
