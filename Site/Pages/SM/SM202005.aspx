...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Caption="Wiki" Width="100%" DataSourceID="ds"
		...
		<Template>
			...
			<px:PXCheckBox CommitChanges="True" ID="chkRequestApproval" runat="server" DataField="RequestApproval"
				Checked="True" />
			...
			<px:PXSelector CommitChanges="True" ID="edCssID" runat="server" DataField="CssID"
				DataSourceID="ds" />
			<px:PXSelector ID="edCssPrintID" runat="server" DataField="CssPrintID" DataSourceID="ds" />
			...
			<%--<px:PXDropDown CommitChanges="True" ID="edWikiArticleType" runat="server" DataField="WikiArticleType"
			...
			<px:PXSelector ID="edFooterPageID" runat="server" DataField="FooterPageID" TextField="Title"
				AutoRefresh="True" DataSourceID="ds" />
			<px:PXTextEdit ID="edPubVirtualPath" runat="server" DataField="PubVirtualPath" /></Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="211px" Style="z-index: 100" Width="100%">
