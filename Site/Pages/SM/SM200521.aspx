<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	CodeFile="SM200521.aspx.cs" Inherits="Page_SM200521" Title="Portal Map Maintenance"
...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" Visible="True" Width="100%" runat="server" PrimaryView="Children" TypeName="PX.SM.PortalMapMaint">
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="cut" DependOnGrid="grid" Visible="False" />
		</CallbackCommands>
		<DataTrees>
			...
			<px:PXGrid ID="grid" runat="server" Height="355px" Width="100%" Style="z-index: 100;
				...
				<Levels>
					<px:PXGridLevel DataMember="Children">
						...
						<Columns>
							<px:PXGridColumn DataField="ScreenID" DisplayFormat="CC.CC.CC.CC" CommitChanges="True" Width="120px" > </px:PXGridColumn> 
