					...
					<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300" SkinID="Horizontal" Height="500px">
						...
						<Template1>
							<px:PXGrid ID="gridUPHistory" runat="server" AdjustPageSize="Auto" DataSourceID="ds" ActionsPosition="Top" AllowPaging="True"
								SkinID="Inquire" Caption="Update History" Width="100%" Height="200px">
								<Levels>
									<px:PXGridLevel DataMember="UpdateHistoryRecords">
										<Columns>
											<px:PXGridColumn DataField="UpdateID" Label="Maintenance ID" TextAlign="Right" Width="50px" />
											<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="FromVersion" Label="From Version" Width="100px" />
											<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ToVersion" Label="To Version" Width="100px" />
						...
						<Template2>
							<px:PXGrid ID="gridUPErrors" runat="server" AdjustPageSize="Auto" DataSourceID="ds" ActionsPosition="Top" AllowPaging="True"
								SkinID="Details" Caption="Update Errors" Width="100%" Height="250px">
								<Levels>
