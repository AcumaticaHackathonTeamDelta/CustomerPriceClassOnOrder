	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%"
		...
		<Levels>
			<px:PXGridLevel DataMember="History">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="NotificationID" TextAlign="Right" Width="108px" TextField="NotificationID_description" />
					<px:PXGridColumn DataField="ExecutionDate" Width="90px" />
					<px:PXGridColumn AllowNull="False" DataField="Status" RenderEditorText="True" Width="63px" />
					<px:PXGridColumn DataField="DateSent" Width="90px" />
					<px:PXGridColumn DataField="MailTo" Width="108px" />
					<px:PXGridColumn DataField="Subject" Width="500px" />
					<px:PXGridColumn DataField="ReportID" Width="63px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
		...
		<ActionBar>
			<CustomItems>
				...
				<px:PXToolBarButton Text="View Report" CommandName="viewReport" CommandSourceID="ds" />
			</CustomItems>
		</ActionBar>
	</px:PXGrid>
</asp:Content>
