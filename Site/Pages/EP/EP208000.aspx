        ...
        <Items>
            <px:PXTabItem Text="General Info">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edDefAccountID" runat="server" DataField="DefaultAccountID">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Rates" DataKeyNames="EquipmentID,ProjectID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMProject__Description" Width="108px" />
                                    <px:PXGridColumn DataField="RunRate" Label="Run Rate" Width="108px" />
                                    <px:PXGridColumn DataField="SetupRate" Label="Run Rate" Width="108px" />
                                    <px:PXGridColumn DataField="SuspendRate" Label="Run Rate" Width="108px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Answers" DataKeyNames="AttributeID,EntityType,EntityID">
                                <Columns>
    								...
    								<px:PXGridColumn DataField="isRequired" TextAlign="Center" Type="CheckBox" Width="60px" AllowResize="False" />
