...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.Objects.GL.GLWorkBookMaint" Visible="True"
        ...
        <DataTrees>
            ...
            <px:PXTreeDataMember TreeView="VoucherEntryScreenTree" TreeKeys="NodeID" />
        </DataTrees>
    </px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" DataMember="WorkBooks" Caption="GL Work Books"
        ...
        <Template>
            ...
            <px:PXTreeSelector ID="edVoucherEditScreen" runat="server" DataField="VoucherEditScreen" PopulateOnDemand="false" AutoRefresh="true"
                ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="VoucherEntryScreenTree" MinDropWidth="413" CommitChanges="true" InitialExpandLevel="5">
                <DataBindings>
                    <px:PXTreeItemBinding DataMember="VoucherEntryScreenTree" TextField="Title" ValueField="NodeID" ImageUrlField="Icon" ToolTipField="TitleWithPath" />
                </DataBindings>
            ...
            <px:PXLayoutRule ID="PXLayoutRule3" runat="server" ControlSize="M" LabelsWidth="M" GroupCaption="Site Map Settings" />
            ...
            <px:PXLayoutRule ID="PXLayoutRule4" runat="server" ControlSize="M" LabelsWidth="M" GroupCaption="Voucher Default Values" />
