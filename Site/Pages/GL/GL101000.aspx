	...
	<px:pxgrid id="grid" runat="server" style="z-index: 100; height: 215px;" width="100%" caption="Financial Periods" skinid="Details" tabindex="200" height="215px">
		...
		<Levels>
			<px:PXGridLevel DataMember="Periods">
				<Columns>
					<px:PXGridColumn DataField="PeriodNbr" Width="100px" />
					<px:PXGridColumn DataField="StartDate"  Width="100px" />
					<px:PXGridColumn DataField="EndDateUI" Width="100px" />
				...
				<RowTemplate>
					...
					<px:PXDateTimeEdit ID="edStartDate" runat="server" DataField="StartDate" DisplayFormat="d" />
