	...
	<px:PXGrid ID="grid1" runat="server" Height="400px" Width="100%" SyncPosition="True"
		...
		<Levels>
			<px:PXGridLevel DataMember="SubRecords">
				<Columns>
					<px:PXGridColumn DataField="SubCD" Width="100px" />
					<px:PXGridColumn DataField="Active" TextAlign="Center" Type="CheckBox" Width="100px" />
					<px:PXGridColumn DataField="Description" Width="300px" />
					<px:PXGridColumn DataField="SubID" TextAlign="Right" Visible="False" AllowShowHide="Server" />
