...
namespace PX.Data
{
	public class PXDBAttributeAttribute : PXDBFieldAttribute
	{
		...
		public PXDBAttributeAttribute(Type valueSearch, Type attributeID)
		{
			...
			{
				throw new PXArgumentException("valueSearch", ErrorMessages.CantCreateForeignKeyReference, valueSearch);
			}
			...
			: this(valueSearch, attributeID)
		{
			...
			{
				throw new PXArgumentException("attributeSearch", ErrorMessages.CantCreateForeignKeyReference, attributeSearch);
			}
		}
