...
namespace PX.Objects.EP
{
	public class TimecardPrimary : PXGraph<TimecardPrimary>
	{
		...
		[PXButton(SpecialType = PXSpecialButtonType.Insert, Tooltip = "Add New Timecard", ImageKey = PX.Web.UI.Sprite.Main.AddNew)]
		[PXUIField]
		...
		[PXButton(Tooltip = "Edit Timecard", ImageKey = PX.Web.UI.Sprite.Main.RecordEdit)]
