...
namespace PX.Objects.EP
{
	...
	public class EmployeeMaint : PXGraph<EmployeeMaint>
	{
		...
		[PXFilterable]
		[CRReference(typeof(Select<EPEmployee, Where<EPEmployee.bAccountID, Equal<Current<EPEmployee.bAccountID>>>>), Persistent = true)]
		...
		public PXAction<EPEmployee> action;
        ...
        protected void UncheckEmployeePositionsIsActive()
			{
					...
					PXSelectBase<EPEmployeePosition> selectSiblings = new PXSelect<EPEmployeePosition, 
						...
						And<EPEmployeePosition.lineNbr, NotEqual<Current<EPEmployeePosition.lineNbr>>>>>(this);
