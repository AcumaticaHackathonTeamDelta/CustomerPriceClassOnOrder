...
namespace PX.Objects.EP
{
	public class EmployeeActivitiesEntry : PXGraph<EmployeeActivitiesEntry>
	{
		...
		[ProjectTask(typeof(EPActivityApprove.projectID), GL.BatchModule.EP, BqlField = typeof(PMTimeActivity.projectTaskID))]
		...
		public class PMTimeActivityFilter : OwnedFilter
		{
			...
			[ActiveProjectTask(typeof(projectID), GL.BatchModule.EP)]
