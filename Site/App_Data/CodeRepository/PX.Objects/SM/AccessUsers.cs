...
namespace PX.SM
{
	...
	public class AccessUsers : Access
	{
		...
		protected override void Users_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			PXDefaultAttribute.SetPersistingCheck<Users.contactID>(sender, user, (user.Guest == true && !string.Equals(user.Username, "anonymous", StringComparison.OrdinalIgnoreCase)) ? PXPersistingCheck.Null : PXPersistingCheck.Nothing);
