...
namespace PX.Objects.CS
{
	...
	{	
		...
		[PXSelector(typeof(PM.PMAccountGroup.groupCD), DescriptionField = typeof(PM.PMAccountGroup.description), ValidateValue = false)]
		...
		[PXSelector(typeof(Search<PMProject.contractCD, Where<PMProject.isTemplate, Equal<False>, And<PMProject.baseType, Equal<PMProject.ProjectBaseType>, And<PMProject.nonProject, Equal<False>>>>>), DescriptionField = typeof(PMProject.description), ValidateValue = false)]
		...
		[PXSelector(typeof(PMTask.taskCD), typeof(PMTask.taskCD), typeof(PMTask.projectID), typeof(PMTask.description), DescriptionField = typeof(PMTask.description), ValidateValue = false)]
		...
		[PXSelector(typeof(InventoryItem.inventoryCD), DescriptionField = typeof(InventoryItem.descr), ValidateValue = false)]
