...
namespace PX.Objects.CS
{
	...
	{
		public readonly Dictionary<Type, PXSelectBase> setupNumberingSequences;
		readonly PXGraph parentGraph;
		...
		/// otherwise, the method returns <tt>False</tt>.</returns>
		protected static bool CanSequencesIntersect(CS.NumberingSequence firstSequence, CS.NumberingSequence secondSequence)
		{
			...
			Int64 firstStartNbr = Convert.ToInt64(firstStart);
			Int64 firstEndNbr = Convert.ToInt64(firstEnd);
			Int64 secondStartNbr = Convert.ToInt64(secondStart);
			Int64 secondEndNbr = Convert.ToInt64(secondEnd);
		...
		/// <returns>The method returns a string with the extracted mask, such as abc999.</returns>
