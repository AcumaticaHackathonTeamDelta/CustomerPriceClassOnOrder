							...
							if (bld.Length == 0 && (ds.AmountType ?? BalanceType.NotSet) != BalanceType.NotSet)
							{
								switch ((short)ds.AmountType)
								{
									...
									case BalanceType.BudgetPTDAmount:
                                        bld.Append(CS.Messages.GetLocal(CS.Messages.BudgetPTDAmount));
										break;
									case BalanceType.BudgetPTDQuantity:
                                        bld.Append(CS.Messages.GetLocal(CS.Messages.BudgetPTDQuantity));
										break;
									case BalanceType.RevisedPTDAmount:
                                        bld.Append(CS.Messages.GetLocal(CS.Messages.RevisedPTDAmount));
										break;
									case BalanceType.RevisedPTDQuantity:
                                        bld.Append(CS.Messages.GetLocal(CS.Messages.RevisedPTDQuantity));
										break;
								}
							}
						}
				...
				if (((IRMType)_RowParentCache.Current).RMType == RMType.PM)
				{
					e.ReturnState = PXIntState.CreateInstance(
						...
						new int[] { BalanceType.NotSet, 
                                    ...
                                    BalanceType.BudgetPTDAmount, 
                                    BalanceType.BudgetPTDQuantity, 
                                    BalanceType.RevisedPTDAmount, 
                                    BalanceType.RevisedPTDQuantity },
						new string[] { CS.Messages.GetLocal(CS.Messages.NotSet),  
                                        ...
                                        CS.Messages.GetLocal(CS.Messages.BudgetPTDAmount),
                                        CS.Messages.GetLocal(CS.Messages.BudgetPTDQuantity),
                                        CS.Messages.GetLocal(CS.Messages.RevisedPTDAmount),
                                        CS.Messages.GetLocal(CS.Messages.RevisedPTDQuantity) },
						null,
						BalanceType.NotSet
						);
				}
