...
namespace PX.Objects.SO
{
	public class SOOrderTypeMaint : PXGraph<SOOrderTypeMaint, SOOrderType>
	{
        public PXSelectJoin<SOOrderType, LeftJoin<SOOrderTypeOperation, On<SOOrderTypeOperation.orderType, Equal<SOOrderType.orderType>, And<SOOrderTypeOperation.operation, Equal<SOOrderType.defaultOperation>>>>,
            Where2<Where<SOOrderTypeOperation.iNDocType, NotEqual<INTranType.transfer>, Or<FeatureInstalled<FeaturesSet.warehouse>>>, And<Where<SOOrderType.requireAllocation, NotEqual<True>, Or<AllocationAllowed>>>>> soordertype;
