namespace PX.Objects.SO
{
	...
	public partial class SOBillingAddress : SOAddress
	{
		...
		[CR.State(typeof(SOBillingAddress.countryID), DescriptionField = typeof(State.name))]
	...
	public partial class SOShippingAddress : SOAddress
	{
		...
		[PXDBString(50, IsUnicode = true)]
		[PXUIField(DisplayName = "State")]
		[CR.State(typeof(SOShippingAddress.countryID), DescriptionField = typeof(State.name))]
		public override String State
		{
			get
			{
	...
	public partial class SOShipmentAddress : SOAddress
	{
		...
		[PXDBString(50, IsUnicode = true)]
		[PXUIField(DisplayName = "State")]
		[CR.State(typeof(SOShipmentAddress.countryID), DescriptionField = typeof(State.name))]
		public override String State
		{
			get
			{
	...
	public partial class SOAddress : PX.Data.IBqlTable, IAddress, IAddressBase
	{
		...
		[PXDBString(50, IsUnicode = true)]
		[PXUIField(DisplayName = "State")]
		[CR.State(typeof(SOAddress.countryID), DescriptionField = typeof(State.name))]
