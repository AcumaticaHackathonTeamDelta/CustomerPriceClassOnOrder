namespace PX.Objects.SO
{
	...
	public partial class SOOrderType : IBqlTable, PXNoteAttribute.IPXCopySettings
	{
		...
		[PXDefault()]
		[PXSelector(typeof(Search<SOOrderTypeT.orderType, Where<SOOrderTypeT.requireAllocation, NotEqual<True>
        ...
        public abstract class requireLotSerial : PX.Data.IBqlField
        {
        }
        ...
        public virtual Boolean? RequireLotSerial
        {
            get
            {
                return this._RequireLotSerial;
            }
            set
            {
                this._RequireLotSerial = value;
            }
        }
        #endregion
		...
		public virtual bool? SupportsApproval
		{
			get
			{
				return _SupportsApproval;
			}
			set
			{
				_SupportsApproval = value;
			}
		}
		#endregion
        #region CopyLotSerialFromShipment
        public abstract class copyLotSerialFromShipment : PX.Data.IBqlField
        {
        }
        ...
        public virtual Boolean? CopyLotSerialFromShipment
        {
            get
            {
                return this._CopyLotSerialFromShipment;
            }
            set
            {
                this._CopyLotSerialFromShipment = value;
            }
        }
        #endregion
		...
		[PXDefault()]
		[PXUIRequired(typeof(FeatureInstalled<FeaturesSet.vendorDiscounts>))]
		...
		public bool CanHaveApplications
		{
			get { return ARDocType == AR.ARDocType.Invoice || ARDocType == AR.ARDocType.DebitMemo; }
		}
	}
