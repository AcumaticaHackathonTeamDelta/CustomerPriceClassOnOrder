namespace PX.Objects.IN
{
	...
	public partial class InventoryItem : PX.Data.IBqlTable, PX.SM.IIncludable, ILotSerNumVal
	{
        ...
        [PXDefault(typeof(Search2<INItemClass.itemClassID, InnerJoin<INSetup, On<INSetup.dfltItemClassID, Equal<INItemClass.itemClassID>>>, Where<INItemClass.stkItem, Equal<Current<InventoryItem.stkItem>>>>))]
		...
		/// </summary>
		/// <value>
		/// Given in the <see cref="INSetup.WeightUOM">default Weight Unit of the Inventory module</see>.
		/// </value>
		[PXDBDecimal(6)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		/// </summary>
		/// <value>
		/// Given in the <see cref="INSetup.VolumeUOM">default Volume Unit of the Inventory module</see>.
		/// </value>
		[PXDBDecimal(6)]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		/// </value>
		 [PXSearchable(SM.SearchCategory.IN, "{0}: {1}", new Type[] { typeof(InventoryItem.itemType), typeof(InventoryItem.inventoryCD) },
		   new Type[] { typeof(InventoryItem.descr) },
			...
			Line1Format = "{0}{1}{2}", Line1Fields = new Type[] { typeof(InventoryItem.itemClassID), typeof(INItemClass.descr), typeof(InventoryItem.baseUnit) },
    ...
    public class CompletePOLineTypes
    {
        ...
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(
                new string[] { Amount, Quantity },
                new string[] { Messages.ByAmount, Messages.ByQuantity }
                )
            { }
        }
