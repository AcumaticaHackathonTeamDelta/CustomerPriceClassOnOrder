...
namespace PX.Objects.FA
{
	...
	public partial class FABookPeriodSetup: IBqlTable, IPeriodSetup
	{
		...
		[PXDate]
		[PXUIField(DisplayName = "End Date", Enabled = false)]
		[PXFormula(typeof(Switch<Case<Where<FABookPeriodSetup.startDate, Equal<FABookPeriodSetup.endDate>>, FABookPeriodSetup.endDate>, Sub<FABookPeriodSetup.endDate, int1>>))]
