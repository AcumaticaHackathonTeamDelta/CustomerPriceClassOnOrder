...
namespace PX.Objects.AP
{
	...
	public partial class APRegister : PX.Data.IBqlTable, IRegister
	{
		#region Selected
		...
		#endregion
		#region DontApprove
		public class screen_expenseClaims : Constant<string> {
			public screen_expenseClaims() : base("EP301030")
			{ }
		}
		public class screen_expenseClaim : Constant<string>
		{
			public screen_expenseClaim() : base("EP301000")
			{ }
		}
		public class screen_releaseExpenseClaims : Constant<string>
		{
			public screen_releaseExpenseClaims() : base("EP501000")
			{ }
		}
		...
		[PXFormula(typeof(Switch<
			Case<Where<
				APRegister.createdByScreenID, Equal<screen_expenseClaim>,
				Or<APRegister.createdByScreenID, Equal<screen_expenseClaims>,
				Or<APRegister.createdByScreenID, Equal<screen_releaseExpenseClaims>,
        ...
        public class SetStatusAttribute : PXEventSubscriberAttribute, IPXRowUpdatingSubscriber, IPXRowInsertingSubscriber
        {
            ...
            public override void CacheAttached(PXCache sender)
            {
                ...
                sender.Graph.FieldUpdating.AddHandler<APRegister.hold>((cache, e) =>
                {
                ...
                sender.Graph.FieldVerifying.AddHandler<APRegister.status>((cache, e) => { e.NewValue = cache.GetValue<APRegister.status>(e.Row); });
				sender.Graph.RowSelecting.AddHandler<APRegister>(RowSelecting);
	            sender.Graph.RowSelected.AddHandler<APRegister>((cache, e) =>
	            {
