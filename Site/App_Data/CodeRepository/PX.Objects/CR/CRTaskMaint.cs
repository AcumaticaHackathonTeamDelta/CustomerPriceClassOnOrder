...
namespace PX.Objects.CR
{
	public class CRTaskMaint : CRBaseActivityMaint<CRTaskMaint, CRActivity>
	{
		...
		[CRReference(typeof(Select<CRActivity, 
			...
			Where<CRActivity.noteID, Equal<Current<CRActivity.noteID>>>>), 
			BAccountRefField = typeof(CRActivity.bAccountID),
			ContactRefField = typeof(CRActivity.contactID))]
		...
		[EPStartDate(DisplayName = "Start Date", DisplayNameDate = "Date", DisplayNameTime = "Start Time", PreserveTime = false, BqlField = typeof(CRActivity.startDate))]
		[PXMergeAttributes(Method = MergeMethod.Replace)]
		protected virtual void CRActivity_StartDate_CacheAttached(PXCache sender) { }

		[EPEndDate(typeof(CRActivity.classID), typeof(CRActivity.startDate), PreserveTime = false, BqlField = typeof(CRActivity.endDate))]
		[PXMergeAttributes(Method = MergeMethod.Merge)]
