...
{
	public class CRCommunicationDeleted : CRCommunicationBase<Where<CRSMEmail.mpstatus, Equal<MailStatusListAttribute.deleted>>>
	{
		...
		static void RestoreMessages(IEnumerable<CRSMEmail> messages)
		{
