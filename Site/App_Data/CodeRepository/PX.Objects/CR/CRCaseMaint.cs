...
namespace PX.Objects.CR
{
	public class CRCaseMaint : PXGraph<CRCaseMaint, CRCase>
	{
		...
		public PXSelectJoin<CRCase, LeftJoin<CRActivityStatistics, On<CRCase.noteID, Equal<CRActivityStatistics.noteID>>>,
		...
		[PXFilterable]
		[CRReference(typeof(Select<BAccount, Where<BAccount.bAccountID, Equal<Current<CRCase.customerID>>>>),
			typeof(Select<Contact, Where<Contact.contactID, Equal<Current<CRCase.contactID>>>>))]
