...
{
    public class CRCommunicationArchive : CRCommunicationBase<Where<CRSMEmail.mpstatus, Equal<MailStatusListAttribute.archived>>>
    {
        ...
        static void RestoreFromArchiveMessages(IEnumerable<CRSMEmail> messages)
        {
