...
namespace PX.Objects.DR
{
	public class DeferredCodeMaint : PXGraph<DeferredCodeMaint, DRDeferredCode>
	{
		...
		protected virtual void DRDeferredCode_RowDeleting(PXCache sender, PXRowDeletingEventArgs e)
		{
			...
			var openScheduleDetail = new PXSelect<DRScheduleDetail, Where<DRScheduleDetail.isOpen, Equal<True>, And<DRScheduleDetail.defCode, Equal<Current<DRDeferredCode.deferredCodeID>>>>>(this).SelectSingle();
			...
			{
				new Tuple<string, object>(Messages.DRScheduleDetail, openScheduleDetail),
