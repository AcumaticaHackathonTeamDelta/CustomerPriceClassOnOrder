...
namespace PX.Objects.DR
{
	public class DRSchedulePrimary : PXGraph<DRSchedulePrimary>
	{
		...
		public PXAction<DRSchedule> update;
		[PXUIField(DisplayName = "")]
		[PXButton(Tooltip = Messages.EditDeferralSchedule, ImageKey = PX.Web.UI.Sprite.Main.RecordEdit)]
		...
		public virtual IEnumerable ViewDoc(PXAdapter adapter)
		{
			...
			{
				NavigationHelper.NavigateToOriginalDocument(this, Items.Current);
			}
			return adapter.Get();
		}
