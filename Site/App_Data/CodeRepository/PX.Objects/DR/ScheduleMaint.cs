...
namespace PX.Objects.DR
{
	...
	public class ScheduleMaint : PXGraph<ScheduleMaint>
	{
		...
		public virtual IEnumerable ViewDoc(PXAdapter adapter)
		{
			...
			{
				NavigationHelper.NavigateToOriginalDocument(this, Schedule.Current);
			}
			else if (Document.Current != null)
			{
				NavigationHelper.NavigateToOriginalDocument(this, Document.Current);
			}
		...
		private void CreateTransactions(DRDeferredCode defCode, int? branchID)
		{
			if (Document.Current != null && Document.Current.Status == DRScheduleStatus.Draft)
			{
				...
				{
					IList<DRScheduleTran> tranList = new TransactionsGenerator(this, defCode).GenerateTransactions(Schedule.Current, Document.Current, branchID);
		...
		public virtual void RebuildProjections(int? branchID)
		{
			...
			IList<DRScheduleTran> tranList = new TransactionsGenerator(this, defCode).GenerateTransactions(sc, Document.Current, branchID);
