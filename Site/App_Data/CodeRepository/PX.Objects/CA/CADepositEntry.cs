...
namespace PX.Objects.CA
{
	...
	public class CADepositEntry : PXGraph<CADepositEntry, CADeposit>
	{
		...
		protected virtual void CADeposit_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			PXDefaultAttribute.SetPersistingCheck<CADeposit.extRefNbr>(sender, row, requireExtRefNbr ? PXPersistingCheck.NullOrBlank : PXPersistingCheck.Nothing);
			PXUIFieldAttribute.SetRequired<CADeposit.extRefNbr>(sender, requireExtRefNbr);
