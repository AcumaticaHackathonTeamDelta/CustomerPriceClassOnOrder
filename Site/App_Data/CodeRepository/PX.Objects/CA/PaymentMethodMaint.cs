	...
	public class PaymentMethodMaint : PXGraph<PaymentMethodMaint, PaymentMethod>
	{
		...
		protected virtual void PaymentMethodAccount_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			if (row != null)
			{
				...
				PXDefaultAttribute.SetPersistingCheck<PaymentMethodAccount.aPLastRefNbr>(cache, e.Row, row.APAutoNextNbr == true ? PXPersistingCheck.NullOrBlank : PXPersistingCheck.Nothing);
			}
		}
