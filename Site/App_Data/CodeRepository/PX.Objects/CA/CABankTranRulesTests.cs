        ...
        protected virtual IEnumerable<RuleTestDefinition> TestsDefinitions
        {
            get
            {
                ...
                yield return new RuleTestDefinition
                {
                    ...
                    Rule = new CABankTranRule { BankTranCashAccountID = 124 },
                    Matches = new List<CABankTran>
                    {
                        new CABankTran { TranID = 1, CashAccountID = 124 },
                        new CABankTran { TranID = 2, CashAccountID = 124, CuryID = "EUR", CuryTranAmt = 100.0m, TranDesc = "Something" }
                    },
                    NotMatches = new List<CABankTran>
                    {
                        new CABankTran { TranID = 0, CuryTranAmt = 150 },
                ...
                yield return new RuleTestDefinition
                {
                    ...
                    Rule = new CABankTranRule { BankTranCashAccountID = 124, AmountMatchingMode = MatchingMode.Equal, CuryTranAmt = 20, BankTranDescription = "FEE" },
                    Matches = new List<CABankTran>
                    {
                        new CABankTran { TranID = 1, CashAccountID = 124, CuryTranAmt = 20.0m, TranDesc = "FEE" },
                        new CABankTran { TranID = 2, CashAccountID = 124, CuryTranAmt = 20.0m, TranDesc = "BANK FEE" }
                    },
                    NotMatches = new List<CABankTran>
                    {
                        new CABankTran { TranID = 0, CashAccountID = 124, CuryTranAmt = 20.0m, TranDesc = "BANK EE" },
                        new CABankTran { TranID = 1, CashAccountID = 124, CuryTranAmt = 21.0m, TranDesc = "BANK FEE" },
