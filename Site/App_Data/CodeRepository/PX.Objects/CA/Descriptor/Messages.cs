...
namespace PX.Objects.CA
{
	...
	public static class Messages
	{
		...
		public const string EarlyInDate = "The receipt date is earlier than the transfer date.";
		...
		public const string ExpDateParseFailed = "Failed to parse the expiration date response. Check your '{0}' setting in the processing center. Processing center response is '{1}' , {0] is '{2}'.";
		...
		public const string ValueValidationNotValid = "Value ValidationField is not valid";
		public const string ValueMaskNotValid = "Value MaskField is not valid";
		#endregion
		...
		public const string FailedGetFrom = "Failed to get the 'FROM' Address for the document";
		public const string FailedGetTo = "Failed to get the 'TO' Address for the document";	
		public const string NotVoidedUnreleased = "Unreleased doc can't be voided";
		public const string ExternalTaxVendorNotFound = TX.Messages.ExternalTaxVendorNotFound;
		public const string MultiCurDepositNotSupported = "Deposit of multiple currencies is not supported yet";
		public const string ProcessingCenterNotSelected = "Processing Center is not selected!";
		public const string ProcessingPluginNotSelected = "Processing plugin is not selected!";
		public const string CredentialsAccepted = "Credentials were accepted by processing center!";
		public const string Result = "Result";
		public const string ResetDetailsToDefault = "Changing Plug-In Type will reset details to default values. Continue?";
		public const string NotSetProcessingCenter = "New Processing Center is not set!";
		public const string ProcessingCenterShouldTokenization = "New processing center should support tokenization!";
		public const string ProcessingCenterShouldNotTokenization = "Old processing center should not support tokenization!";
		public const string AskConfirmation = AP.Messages.AskConfirmation;
		public const string PaymentMethodDetailsWillReset = "Details for the payment method will be reset. Continue?";
		public const string ParameterShouldNotNull = "Parameter should not be null";
		...
		public const string ValueMInstanceIdError = @"Value of parameter ""pMInstanceID"" cannot be represented as an Integer";
		#endregion
