...
namespace PX.Objects.GL
{
	...
	public class ScheduleRun : ScheduleRunBase<ScheduleRun, ScheduleMaint, ScheduleProcess>
	{
		...
		public partial class Parameters : IBqlTable
		{
			...
			[PXDBDate]
			[PXUIField(DisplayName = Messages.StartOn, Visibility = PXUIVisibility.Visible)]
			...
			[PXDefault(ScheduleRunLimitType.RunMultipleTimes)]
			...
			[PXUIField(DisplayName = Messages.OnThisDate, Visibility = PXUIVisibility.Visible)]
			public virtual DateTime? EndDate { get; set; }
			#endregion
			#region RunLimit
			public abstract class runLimit : IBqlField { }
			[PXDBShort(MinValue = 1)]
			[PXUIField(DisplayName = Messages.AfterThisNumberOfScheduleExecutions, Visibility = PXUIVisibility.Visible)]
