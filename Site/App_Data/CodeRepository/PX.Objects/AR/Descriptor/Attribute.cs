...
namespace PX.Objects.AR
{
		...
		public static CATran DefaultValues(PXCache sender, CATran catran_Row, ARPayment orig_Row)
		{
			...
			switch (parentDoc.DocType)
			{
				...
				case ARDocType.VoidPayment:
					...
					alterVoidedType = ARDocType.Prepayment;
					break;
            ...
            if (!string.IsNullOrEmpty(voidedType))
            {
				...
				{
					ARPayment alterVoidedDoc = PXSelectReadonly<ARPayment, Where<ARPayment.refNbr, Equal<Required<ARPayment.refNbr>>,
											   And<ARPayment.docType, Equal<Required<ARPayment.docType>>>>>.Select(sender.Graph, refNbr, alterVoidedType);
	...
	public class ARPaymentChargeSelect<PaymentTable, PaymentMethodID, CashAccountID, AdjDate, AdjFinPeriodID, PMInstanceID, WhereSelect> :
		AP.PaymentChargeSelect<PaymentTable, PaymentMethodID, CashAccountID, AdjDate, AdjFinPeriodID, 
			ARPaymentChargeTran, ARPaymentChargeTran.entryTypeID, WhereSelect>
