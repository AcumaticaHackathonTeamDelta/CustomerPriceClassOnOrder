...
namespace PX.Objects.RUTROT
{
	...
	{
		public RUTExport(List<RUTROTWorkType> availableWorkTypes)
		{
			AvailableWorkTypes = availableWorkTypes;
		}
		#region Elements
		protected const string NsMain = "http://xmls.skatteverket.se/se/skatteverket/ht/begaran/4.0";
		protected const string NsHtko = "http://xmls.skatteverket.se/se/skatteverket/ht/komponent/begaran/4.0";
		protected const string NsXsi = "http://www.w3.org/2001/XMLSchema-instance";
		protected const string SchemaLocation = "http://xmls.skatteverket.se/se/skatteverket/ht/begaran/4.0 Begaran.xsd";
		...
		protected List<RUTROTWorkType> AvailableWorkTypes;
		...
		protected virtual void WriteDoneWork(RUTExportItem item)
		{
			...
			foreach (RUTROTWorkType workType in AvailableWorkTypes)
			{
	...
	{
		public ROTExport(List<RUTROTWorkType> availableWorkTypes) : base(availableWorkTypes)
		{ }
		#region Elements
	...
	public class RUTExportItem
	{
		...
		public string ROTEstate { get; set; }
		public string ROTAppartment { get; set; }
		public string ROTOrganizationNbr { get; set; }
		public Dictionary<int?, int> HoursAmt { get; set; }
		public Dictionary<int?, decimal> MaterialCost { get; set; }

		public static IEnumerable<RUTExportItem> Create(ClaimRUTROTProcess.DocumentDetails document, List<RUTROTWorkType> availableWorkTypes)
		{
			...
			foreach (ARTran tran in document.Lines)
			{
				...
				try
				{
					...
					{
						materialCost[tranRR.RUTROTWorkTypeID] += tran.CuryTranAmt ?? 0m;
					}
		...
		public static IEnumerable<RUTExportItem> Create(IEnumerable<ClaimRUTROTProcess.DocumentDetails> documents, List<RUTROTWorkType> availableWorkTypes)
		{
