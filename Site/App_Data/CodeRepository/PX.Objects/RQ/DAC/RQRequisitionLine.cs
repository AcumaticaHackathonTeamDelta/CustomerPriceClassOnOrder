...
using PX.Objects.PO;
	...
	public partial class RQRequisitionLine : PX.Data.IBqlTable
	{
		...
		[AlternativeItem(INPrimaryAlternateType.VPN, typeof(RQRequisitionLine.inventoryID), typeof(RQRequisitionLine.subItemID))]
        ...
        [UOMDefault(INUOMDefaulType.Purchase, typeof(RQRequisitionLine.inventoryID), typeof(RQRequisitionLine.siteID))]
		...
		[PXDBPriceCost()]
		[PXDefault(TypeCode.Decimal, "0.0",
			typeof(Search<InventoryItem.markupPct, Where<InventoryItem.inventoryID, Equal<Current<RQRequisitionLine.inventoryID>>>>))]
	...
	public static class RQTransferType
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { None, Split, Transfer },
				new string[] { Messages.None, Messages.Split, Messages.Transfer }) { }
		}
	...
	public static class RQRequisitionReceivedStatus
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { Open, Partially, Closed, Ordered},
				new string[] { Messages.Open, Messages.PartiallyReceived, Messages.Received, Messages.Canceled }) { }
		}
