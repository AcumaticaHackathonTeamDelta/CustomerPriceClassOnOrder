...
<%--	<px:PXSmartPanel ID="PanelTFS" runat="server" Caption="Source Control Binding"  
	...
	<px:PXSmartPanel ID="PanelTFSConfig" runat="server" Caption="Source Control Setup"  
	   ...
	   <px:PXSmartPanel runat="server" ID="PanelCheckinFiles" Width="600px" Height="400px" CaptionVisible="True" Key="ViewCheckinFiles"
        Caption="Modified Files Detected" ShowMaximizeButton="True" Overflow="Hidden" AutoCallBack-Enabled="True" AutoCallBack-Target="ds"
        AutoCallBack-Command="actionShowDlgCheckinFiles">

		   
	   <px:PXLabel runat="server" Text="Some files has been modified manually by the user on the file system. Please resolve conflicts."></px:PXLabel>
        <px:PXGrid runat="server" ID="gridCheckinFiles" DataSourceID="ds" Width="100%" BatchUpdate="True" AutoAdjustColumns="True" SkinID="Details">
            <Levels>
			...
			<ActionBar Position="Top" ActionsHidden="True">
				<CustomItems>
					<px:PXToolBarButton Text="Update Customization Project">
						<AutoCallBack Enabled="True" Target="ds" Command="actionFileCheckIn">
                    </AutoCallBack>
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="Discard all changes">
